...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/calendar', title: 'Calendar', icon: 'ft-calendar', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    {
        ...
        submenu: [
            ...
            { path: '/pages/profile', title: 'Transporteur Profile', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    ...
    {
        path: '', title: 'Configuration', icon: 'fa icon-wrench', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false,
        submenu: [
            { path: '/egf/configuration/type-devis', title: 'Type de devis', icon: 'ft-grid', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/egf/configuration/type-colis', title: 'Type de colis', icon: 'ft-layout', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/egf/configuration/nature-colis', title: 'Nature du colis', icon: 'fa fa-ils', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/egf/configuration/ville-escale', title: 'Ville d\'escale', icon: 'fa fa-map-o', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/egf/configuration/point-depot', title: 'Point de depots', icon: 'fa fa-map-pin', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/egf/configuration/type-acheminement', title: 'Type d\'achéminement', icon: 'fa fa-road', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/egf/configuration/societes', title: 'Sociétes', icon: 'fa fa-university', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/egf/configuration/trajets', title: 'Trajets', icon: 'fa fa-road', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
        ]
    },

    {
        ...
        submenu: [
            { path: '/egf/administration/users', title: 'Utilisateurs', icon: 'ft-users', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/egf/administration/transporteurs', title: 'Transporteurs', icon: 'fa fa-user', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/egf/administration/expediteurs', title: 'Expediteurs', icon: 'fa fa-user', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/egf/administration/profils', title: 'Profils', icon: 'ft-life-buoy', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/egf/administration/roles', title: 'Roles', icon: 'fa fa-lock', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
        ]
    },
